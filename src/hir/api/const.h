...
static inline HirConst hir_const_new_string_ptr(Mempool *mempool, Slice string) {
    HirConst constant = {
        .kind = HIR_CONST_STRING_PTR,
        .type = hir_type_new_pointer(mempool, hir_type_new_int(mempool, HIR_TYPE_INT_8, false)),
        .string = string
    };
    return constant;
}
