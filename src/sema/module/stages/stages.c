...
#include "sema/module/stages/fill_direct_types.h"
#include "sema/module/stages/fill_generics.h"
#include "sema/module/stages/fill_types.h"
#include "sema/module/stages/init_decls.h"

#define SEMA_STAGES_COUNT 6

size_t sema_stages_count = SEMA_STAGES_COUNT;
size_t sema_setup_stages_count = 5;

SemaStage sema_stages[SEMA_STAGES_COUNT] = {
    sema_module_init_node_decls,
    sema_module_fill_node_generics,
    sema_module_fill_direct_types,
    sema_module_fill_types,
